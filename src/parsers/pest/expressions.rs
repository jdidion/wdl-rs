use crate::{
    ast::{
        ...
        Integer, MapEntry, MapLiteral, ObjectField, ObjectLiteral, PairLiteral, StringLiteral,
...
impl<'a> TryFrom<Pair<'a, Rule>> for Expression {
    ...
    fn try_from(pair: Pair<Rule>) -> Result<Self> {
        ...
        let e = match expr_pair.as_rule() {
            Rule::ternary => Self::Ternary(Ternary::try_from(expr_pair)?),
            ...
            Rule::negation | Rule::inversion => Self::Unary(Unary::try_from(expr_pair)?),
            Rule::apply => Self::Apply(Apply::try_from(expr_pair)?),
            Rule::access => Self::Access(Access::try_from(expr_pair)?),
            Rule::none => Self::None,
            Rule::true_literal => Self::Boolean(true),
            Rule::false_literal => Self::Boolean(false),
            Rule::int => Self::Int(Integer::try_from(expr_pair)?),
            Rule::float => Self::Float(Float::try_from(expr_pair)?),
            Rule::string => Self::String(StringLiteral::try_from(expr_pair)?),
            Rule::array => Self::Array(ArrayLiteral::try_from(expr_pair)?),
            Rule::map => Self::Map(MapLiteral::try_from(expr_pair)?),
            Rule::pair => Self::Pair(PairLiteral::try_from(expr_pair)?),
            Rule::object => Self::Object(ObjectLiteral::try_from(expr_pair)?),
